...
public class Restaurant extends JFrame {
	...
	public Restaurant() {
		...
		JLabel etiket = new JLabel("           ÜRÜN                           	 ADET                             FÝYAT");
		...
		JLabel restaurant_name = new JLabel("AKÝNSA RESTAURANT");
		...
		cancel_btn.setIcon(new ImageIcon(Restaurant.class.getResource("cancel.jpeg")));
		
		JButton ödeme_btn = new JButton();
		ödeme_btn.setBackground(new Color(0, 255, 0));
		ödeme_btn.setBounds(909, 441, 161, 59);
		ödeme_btn.setIcon(new ImageIcon(Restaurant.class.getResource("okey.jpeg")));
		...
		JRadioButton kredikarti_rbtn = new JRadioButton("Kredi Kartý");
		...
		JLabel pbg1 = new JLabel(new ImageIcon(getClass().getResource("bg2.jpeg")));
		pbg1.setBounds(0, 0, 600, 400);
		p1.add(pbg1);
		JLabel pbg2 = new JLabel(new ImageIcon(getClass().getResource("bg2.jpeg")));
		pbg2.setBounds(0, 0, 600, 400);
		p2.add(pbg2);
		JLabel pbg3 = new JLabel(new ImageIcon(getClass().getResource("bg2.jpeg")));
		pbg3.setBounds(0, 0, 600, 400);
		p3.add(pbg3);
		JLabel pbg4 = new JLabel(new ImageIcon(getClass().getResource("bg2.jpeg")));
