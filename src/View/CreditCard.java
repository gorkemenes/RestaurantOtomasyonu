...
public class CreditCard extends Restaurant {
	...
	public CreditCard(String toplamtutar) {
		...
		JCheckBox tüketicionay = new JCheckBox("Tüketici Onayi");
		tüketicionay.setBackground(Color.WHITE);
		tüketicionay.setBounds(200, 165, 99, 23);

		JCheckBox kullansöz = new JCheckBox("Kullanici Sözleşmesi");
		...
		month_cbx.setModel(new DefaultComboBoxModel(new String[] { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" }));
		...
		year_cbx.setModel(new DefaultComboBoxModel(new String[] { "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030","2031", "2032", "2033", "2034", "2035", "2036", "2037", "2038", "2039", "2040", "2041" }));
						...
						if (cardNo_txt.getText().length() != 16)
						{
							...
							if (cvc_txt.getText().length() !=3)
							{
								...
								if (tüketicionay.isSelected() && kullansöz.isSelected()) {
									...
									JOptionPane.showMessageDialog(null, "Ödeme Alindi Teþekkürler.");
									dispose();
								}

							else {
							JOptionPane.showMessageDialog(null, "Lütfen Tüm Sözlesmeleri Onaylayiniz! ");
							}
							}
						}
